...
public class MemoryClientDAO implements DAO<Client> {
     ...
     * @throws ObjectNotFoundException If no `Client` is found with the given ID.
     */
    @Override
    public Client getById(long id) {
        try {
            ...
            throw new ObjectNotFoundException("ID de Cliente no encontrado " + id); // Throw the custom exception.
        }
     ...
     * @throws DuplicateObjectException If a `Client` with the same DNI already exists.
     */
    @Override
    public Client save(Client client) {
        ...
        if (exists) {
            throw new DuplicateObjectException("DNI " + client.getDni() + " ya existe."); //Throw Duplicate Exception.
        }
    ...
    public Client updateById(long id, Client client) {
        ...
        if(existingClient == null){
            throw new ObjectNotFoundException("ID de Cliente no encontrado " + id);
        }
